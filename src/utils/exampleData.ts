...
const preNoteStepUp2 = [
  ...
  },
  {
    ...
    imgAlt: "책의 목차에 핵심 메시지가 담겨있음을 강조하는 이미지",
  },
];
...
const preNoteStepUp3 = [
  {
    ...
    imgAlt: "돋보기로 책을 살피고 질문을 던지는 이미지",
  },
];
...
export const periNoteStepUp = [
  ...
  },
  {
    ...
    imgAlt: "독서 전, 미리 작성한 질문리스트에 답변을 작성하는 이미지",
  },
  {
    id: 3,
    lifeQuote: "",
